...
export class ResumeParsingServiceError extends Error {
...
export const MAX_RESUME_LENGTH =
  40_000;
...
${resumeText}
    ...
    console.error(
      "Groq resume parsing request failed:",
  ...
  try {
    ...
    console.error(
      "Groq resume parsing response was not valid JSON:",
      error
    );

    throw new ResumeParsingServiceError(
      "AI 분석 결과 형식을 확인할 수 없습니다.",
      502,
      "AI_INVALID_RESPONSE"
    );
  }
